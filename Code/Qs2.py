...
input_image = cv2.imread("Images\\1-3.jpg", cv2.IMREAD_COLOR)

character_templates = {
    'A': cv2.imread("Images\\A.png", cv2.IMREAD_COLOR),
    '8': cv2.imread("Images\\8.png", cv2.IMREAD_COLOR),
    'W': cv2.imread("Images\\W.png", cv2.IMREAD_COLOR)
}
